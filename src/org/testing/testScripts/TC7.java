...
public class TC7 {
	...
	public void testWatchLater() throws InterruptedException
	{
		...
		//driver.findElement(By.xpath("//input[@id='phoneNumberId']")).sendKeys("8800230378");
		//driver.findElement(By.xpath("//div[@id='idvanyphonecollectNext']")).click();
		System.out.println("Successfully login you tube");
		driver.findElement(By.xpath("//yt-formatted-string[text()='Watch later']")).click();
		System.out.println("successfully click on Watch Later");
		Thread.sleep(4000);
